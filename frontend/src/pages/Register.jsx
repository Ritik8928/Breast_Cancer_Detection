...
const Register = () => {
  ...
  const handleSendOTP = async () => {
    ...
    try {
      const response = await fetch('https://breast-cancer-detection-gthe.onrender.com/api/otp/send', {
        method: 'POST',
  ...
  const handleVerifyOTP = async () => {
    ...
    try {
      // Verify OTP
      const verifyResponse = await fetch('https://breast-cancer-detection-gthe.onrender.com/api/otp/verify', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ 
      ...
      // Register user
      const registerResponse = await fetch('https://breast-cancer-detection-gthe.onrender.com/api/auth/register', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
