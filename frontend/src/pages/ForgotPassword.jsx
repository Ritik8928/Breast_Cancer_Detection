...
const ForgotPassword = () => {
  ...
  const handleSendOTP = async (e) => {
    ...
    try {
      // ✅ FIXED: Render URL
      const response = await fetch('https://breast-cancer-detection-gthe.onrender.com/api/forgot-password/send-otp', {
        method: 'POST',
  ...
  const handleVerifyOTP = async (e) => {
    ...
    try {
      // ✅ FIXED: Render URL
      const response = await fetch('https://breast-cancer-detection-gthe.onrender.com/api/forgot-password/verify-otp', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      // ✅ FIXED: Render URL
      const response = await fetch('https://breast-cancer-detection-gthe.onrender.com/api/forgot-password/reset', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
